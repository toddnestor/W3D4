...
ActiveRecord::Schema.define(version: 20160929185212) do
  ...
  add_index "responses", ["user_id", "answer_id"], name: "index_responses_on_user_id_and_answer_id", unique: true, using: :btree
